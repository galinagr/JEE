...
CREATE TABLE NewTable AS(SELECT P.projectName, D.salary
FROM DEVELOPERS D
...
AND COM.custId !=COM1.custId),COMPANIES COM1
...
(IMP_ID, salary, projectName, SKILL)
		AS SELECT DEV.IMP_ID, DEV.salary, PR.projectName, SKILLS.SKILL
